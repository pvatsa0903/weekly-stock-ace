...
import { ThumbsUp, ThumbsDown, Lightbulb, RefreshCw, ChevronDown, ChevronUp } from "lucide-react";
...
export const LiveWeeklyBanner = ({ ticker, aiDecision, aiConfidence, aiEli5, aiWhy }: LiveWeeklyBannerProps) => {
  ...
  return (
    <div className="rounded-2xl overflow-hidden">
      <Link to={`/ticker?symbol=${data.ticker}`} className="block">
        <div
          className={cn(
            "p-6 text-white relative overflow-hidden transition-transform hover:scale-[1.02]",
